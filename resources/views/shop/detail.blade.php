                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('user.transaction') }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <input class="form-control" type="hidden" id="nama" name="id_toko" value="{{$data->id_toko}}">
                                    <input class="form-control" type="hidden" id="nama" name="id_pembeli" value="{{Auth::user()->id}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="pengambilan" placeholder="Pengambilan" name="pengambilan" value="{{date("Y-m-d H:i:s")}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="pengambilan">Tanggal Kembali</label>
                                        <input type="date" class="form-control" id="pengambilan" placeholder="Pengambilan" name="pengembal" value="{{date("Y-m-d H:i:s")}}">
                                    </div>
